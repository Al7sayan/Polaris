	...
	namespace utilities
	{
		...
		*/
		...
		VOID SDKUtils::InitSdk()
		{
			...
			auto pGEngineAddress = SDKUtils::FindPattern("\x48\x8B\xD3\x00\x00\x00\x00\x00\x48\x8B\x4C\x24\x40\x48\x89\x05\x00\x00\x00\x00\x48\x85\xC9", "xxx?????xxxxxxxx????xxx");
			auto pGEngineOffset = reinterpret_cast<SDK::UEngine**>(pGEngineAddress + 22 + *(int32_t*)(pGEngineAddress + 18));
			...
			auto pStaticConstructObject_InternalOffset = FindPattern("\xE8\x00\x00\x00\x00\x44\x8D\x4D\x01", "x????xxxx");
